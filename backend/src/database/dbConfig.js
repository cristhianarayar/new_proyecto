...
const initDatabase = () => {
    ...
    `CREATE TABLE ciudad IF NOT EXISTS(
    ...
    `CREATE TABLE comuna IF NOT EXISTS(
    ...
    `CREATE TABLE banco IF NOT EXISTS(
    ...
    `INSERT INTO cuenta VALUES (DEFAULT,'Cta. Corriente'),
    (DEFAULT,'Cta. Vista'),
    (DEFAULT,'Cta. Ahorro')`;
    ...
    `CREATE TABLE detalle_venta IF NOT EXISTS(
	id_det INTEGER,
	per_rut VARCHAR (9),
	id_prod INTEGER,
	det_cant INTEGER,
    ...
    `CREATE TABLE ventas IF NOT EXISTS(
